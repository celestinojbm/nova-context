...
| EV-06 | security | `docs/AUDIT_RESPONSE_M15.md` (3 Hermes audits → conditional pass), `docs/SECURITY_PRIVACY_GOVERNANCE.md`, `docs/RISKS_AND_RED_TEAM.md` | external adversarial review + remediation trail; accepted P2 residual documented | pentest of a running deployment | baseline | high | operator |
...
| EV-14 | ip | `git shortlog -sne`: two identities (operator + AI assistant co-authorship trailers) | authorship record as recorded in git | chain of title, assignments, license posture (NO LICENSE file exists) | baseline | low | operator + legal |
